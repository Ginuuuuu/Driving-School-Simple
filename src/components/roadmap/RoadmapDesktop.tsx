        ...
        <div className="lg:col-span-5 bg-slate-950/80 rounded-2xl p-6 border border-slate-800/80 flex flex-col justify-between min-h-[440px]">
          <div>
            <div className="flex items-center justify-between text-xs text-slate-400 mb-4 pb-3 border-b border-slate-800">
              <span className="flex items-center gap-1.5 text-[#FFC5DC] font-bold">
            ...
            <div className="relative h-64 w-full bg-slate-900 rounded-xl overflow-hidden flex items-center justify-center border border-slate-800">
              {/* Asphalt Road Canvas */}
              <div className="absolute inset-x-8 inset-y-4 bg-slate-800/90 rounded-2xl border-x-2 border-dashed border-[#BC2639]/40 flex items-center justify-center">
                {/* Lane Divider Dashes */}
                ...
                >
                  <RoadmapCar />
                  <div className="mt-2 px-2.5 py-0.5 rounded-full bg-slate-950/90 border border-[#BC2639]/50 text-[0.65rem] font-mono text-[#FFC5DC] font-bold uppercase tracking-wider">
              ...
              <div className="absolute bottom-2 right-3 text-[0.65rem] font-bold uppercase tracking-wider text-[#FFC5DC] flex items-center gap-1">
                <Award className="w-3 h-3 text-[#BC2639]" /> Finish: Smart DL
              </div>
            </div>
          </div>
          ...
          {activeStep.rtoPortalUrl && (
            <div className="mt-4 pt-3 border-t border-slate-800 flex items-center justify-between text-xs">
              ...
              <a
                ...
                className="inline-flex items-center gap-1 text-[#FFC5DC] hover:text-white font-bold underline"
              >
                Parivahan Sarathi Gov Portal <ExternalLink className="w-3 h-3 text-[#BC2639]" />
              </a>
            </div>
          )}
        </div>
        ...
        <div className="lg:col-span-7 space-y-6">
          <AnimatePresence mode="wait">
            ...
            >
              {/* Title & Summary */}
              <div>
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-[#BC2639]/20 text-[#FFC5DC] border border-[#BC2639]/30 mb-2">
                  <Sparkles className="w-3.5 h-3.5 text-[#BC2639]" />
              ...
              {activeStep.requiredDocuments.length > 0 && (
                <div className="p-4 rounded-2xl bg-slate-800/60 border border-slate-700/80">
                  <h4 className="text-xs font-bold uppercase tracking-wider text-[#FFC5DC] mb-3 flex items-center gap-1.5">
                  ...
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-slate-300">
                    {activeStep.requiredDocuments.map((doc, i) => (
                      <li key={i} className="flex items-start gap-2">
                        <CheckCircle2 className="w-3.5 h-3.5 text-[#BC2639] mt-0.5 shrink-0" />
              ...
              {activeStep.rtoTrackManeuvers && (
                <div className="p-4 rounded-2xl bg-slate-800/60 border border-slate-700/80">
                  <h4 className="text-xs font-bold uppercase tracking-wider text-[#FFC5DC] mb-3 flex items-center gap-1.5">
                    <Award className="w-4 h-4 text-[#BC2639]" />
              ...
              <div className="p-4 rounded-2xl bg-gradient-to-r from-[#5F1618]/40 to-slate-800/60 border border-[#BC2639]/30 flex items-start gap-3.5">
                <div className="p-2 rounded-xl bg-[#BC2639]/20 text-[#FFC5DC] shrink-0">
                  <Lightbulb className="w-5 h-5 text-[#BC2639]" />
                </div>
                <div>
                  <h5 className="text-xs font-bold uppercase tracking-wider text-[#FFC5DC]">
                    ...
                    >
                      <span className={`px-2 py-0.5 rounded text-[0.65rem] font-bold ${
                        item.officialRequirement
                          ? 'bg-[#BC2639]/20 text-[#FFC5DC] border border-[#BC2639]/30'
                          : 'bg-[#5F1618]/40 text-[#FAF6F8] border border-[#BC2639]/30'
                      }`}>
