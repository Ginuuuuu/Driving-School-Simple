  ...
  return (
    <footer className="bg-gradient-to-b from-[#24060E] to-[#140207] text-[#FAF6F8] pt-8 pb-6 sm:pt-16 sm:pb-12 border-t border-[#BC2639]/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-10 lg:gap-8 mb-6 sm:mb-12">
          ...
          <div className="grid grid-cols-2 gap-4 lg:col-span-2 lg:grid-cols-2">
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <ul className="space-y-1 sm:space-y-2 text-xs sm:text-sm text-[#D4E2DF]">
                {courses.slice(0, 5).map((course) => (
                  <li key={course.id}>
                    <Link
                      to={`/courses/${course.slug}`}
                      className="hover:text-[#BC2639] transition-colors flex items-center justify-between group"
                    >
                      <span className="truncate">{course.shortTitle}</span>
                      <ArrowUpRight className="w-3 h-3 opacity-0 group-hover:opacity-100 text-[#BC2639] transition-opacity hidden sm:inline" />
                    </Link>
                  </li>
                ))}
                <li>
                  <Link to="/courses" className="text-[#BC2639] font-semibold hover:underline inline-block pt-0.5 text-[0.7rem] sm:text-xs">
                    All Courses →
                  </Link>
                </li>
              </ul>
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <ul className="space-y-1 sm:space-y-2 text-xs sm:text-sm text-[#D4E2DF]">
                <li>
                  <Link to="/roadmap" className="hover:text-[#BC2639] transition-colors flex items-center gap-1">
                    <span className="truncate">Licence Roadmap</span>
                    <span className="px-1 py-0.2 text-[0.6rem] font-bold bg-[#BC2639]/20 text-[#FFC5DC] rounded hidden sm:inline">
                      RTO
                    </span>
                  </Link>
                </li>
                <li>
                  <Link to="/about" className="hover:text-[#BC2639] transition-colors truncate block">
                    About Academy
                  </Link>
                </li>
                <li>
                  <Link to="/instructors" className="hover:text-[#BC2639] transition-colors truncate block">
                    Our Instructors
                  </Link>
                </li>
                <li>
                  <Link to="/pricing" className="hover:text-[#BC2639] transition-colors truncate block">
                    Pricing & Plans
                  </Link>
                </li>
                <li>
                  <Link to="/resources" className="hover:text-[#BC2639] transition-colors truncate block">
                    Road Signs & Guides
                  </Link>
                </li>
                <li>
                  <Link to="/faq" className="hover:text-[#BC2639] transition-colors truncate block">
                    FAQs
                  </Link>
                </li>
                <li>
                  <Link to="/contact" className="hover:text-[#BC2639] transition-colors truncate block">
                    Locations & Hubs
                  </Link>
                </li>
              </ul>
          ...
          <div className="space-y-2 sm:space-y-3">
            ...
            <div className="grid grid-cols-2 sm:flex sm:flex-col gap-2 sm:gap-2.5 text-xs sm:text-sm text-[#D4E2DF]">
              <a
                href={`tel:${siteConfig.phoneDial}`}
                className="flex items-center gap-2 p-2 sm:p-0 rounded-lg sm:rounded-none bg-[#26230A]/60 sm:bg-transparent border border-[#5F1618]/40 sm:border-none hover:text-white transition-colors"
              >
              ...
              <a
                ...
                className="flex items-center gap-2 col-span-2 sm:col-span-1 p-2 sm:p-0 rounded-lg sm:rounded-none bg-[#26230A]/60 sm:bg-transparent border border-[#5F1618]/40 sm:border-none hover:text-white transition-colors text-xs truncate"
              >
                <Mail className="w-3.5 h-3.5 text-[#BC2639] shrink-0" />
                <span className="truncate">{siteConfig.email}</span>
              </a>

              <div className="flex items-start gap-2 col-span-2 sm:col-span-1 p-2 sm:p-0 rounded-lg sm:rounded-none bg-[#26230A]/60 sm:bg-transparent border border-[#5F1618]/40 sm:border-none text-[0.7rem] sm:text-xs text-[#D4E2DF] leading-snug">
                <MapPin className="w-3.5 h-3.5 text-[#BC2639] shrink-0 mt-0.5" />
        ...
        {/* Bottom Bar */}
        <div className="pt-4 sm:pt-8 mt-4 sm:mt-8 border-t border-[#5F1618]/60 flex flex-col sm:flex-row items-center justify-between gap-2.5 sm:gap-4 text-[0.7rem] sm:text-xs text-[#D4E2DF]/70 text-center sm:text-left">
          <p>
