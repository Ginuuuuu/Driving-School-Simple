...
export const TestimonialCard: React.FC<TestimonialCardProps> = ({ testimonial }) => {
  return (
    <div className="flex flex-col justify-between h-full rounded-2xl sm:rounded-3xl bg-white border border-slate-200/90 p-3.5 sm:p-7 shadow-xs hover:shadow-md hover-lift transition-all duration-300">
      <div>
