  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8 space-y-6 sm:space-y-8 lg:space-y-10">
      ...
      <motion.section
        ...
        viewport={{ once: true, margin: "-30px" }}
        transition={{ duration: 0.45 }}
        className="bg-[#39340F] text-white rounded-2xl sm:rounded-3xl p-4 sm:p-10 border border-[#5F1618] space-y-4 sm:space-y-6 shadow-xl"
      >
        <div className="flex items-center gap-2 text-[#FFC5DC] font-bold text-[0.7rem] sm:text-xs uppercase tracking-wider">
        ...
        <p className="text-xs sm:text-sm text-[#D4E2DF] leading-relaxed max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 sm:gap-4 pt-1 sm:pt-2">
          <div className="p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-[#26230A]/70 border border-[#5F1618]/60 space-y-1 hover-lift-subtle transition-all">
            <h3 className="text-xs sm:text-sm font-bold text-[#FFC5DC]">Figure "8" Track</h3>
            <p className="text-[0.72rem] sm:text-xs text-[#D4E2DF]">
