    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-10 space-y-6 sm:space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 sm:gap-8">
        {resources.map((guide) => (
          <div
            key={guide.id}
            className="p-3.5 sm:p-8 rounded-2xl sm:rounded-3xl bg-white border border-slate-200 shadow-xs hover:shadow-md transition-all flex flex-col justify-between space-y-3 sm:space-y-4"
          >
            <div>
